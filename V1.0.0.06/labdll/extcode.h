...
TH_REENTRANT MgErr _FUNCC	FRemoveToRecycle(Path path, Bool32 showConfirmDlgs);
...
TH_REENTRANT MgErr _FUNCC	FListDir(Path path, FDirEntHandle list, FMListDetails **);
